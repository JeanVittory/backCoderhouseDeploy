...
const putProductsById = async (req, res) => {
	try {
		...
		if (responseFromUpdatecontroller?.message) {
			logger.error(`${responseFromUpdatecontroller.status}. ${responseFromUpdatecontroller.message}`);
			res
...
const deleteProductsById = async (req, res) => {
	try {
		...
		if (responseFromDeleteController?.message) {
			logger.error(`${responseFromDeleteController.status}. ${responseFromDeleteController.message}`);
